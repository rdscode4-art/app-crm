                    ...
                    if (filteredDocs.isEmpty)
                      const Center(
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Icon(Icons.folder_open_outlined, size: 48, color: AppColors.textSecondary),
                              SizedBox(height: 12),
                              Text("No document records listed.", style: TextStyle(color: AppColors.textSecondary)),
                            ],
                          ),
                        ),
                      )
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, idx) {
                          ...
                          final formattedDate = "${doc.uploadDate.day}/${doc.uploadDate.month}/${doc.uploadDate.year}";
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                IconButton(
                                  icon: const Icon(Icons.download_for_offline_outlined, color: AppColors.primary, size: 20),
                                  onPressed: () {
                                    Get.snackbar(
                                      "Downloading File",
